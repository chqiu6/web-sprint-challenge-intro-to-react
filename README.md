...
React js is a user interface component library. It does a good job in rendering UI. Everything is a component. We cam use JSX which allows us to write HTML. 

1. Describe component state.
Component state is the current initial environment ?


1. Describe props.
Props is a way to pass information from one component to another.


1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are things that affect something outside the scope of the function being executed. To sync effects we use the dependency array as the second
argument. 
